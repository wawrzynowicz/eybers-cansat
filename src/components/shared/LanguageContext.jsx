  ...
  en: {
    ...
    projectDesc: {
      ...
      specs: {
        ...
        items: {
          dimensions: { label: "Dimensions", value: "115 mm × Ø 66 mm" },
          mass: { label: "Mass", value: "300-350g" },
  ...
  pl: {
    ...
    projectDesc: {
      ...
      specs: {
        ...
        items: {
          dimensions: { label: "Wymiary", value: "115 mm × Ø 66 mm" },
          mass: { label: "Masa", value: "300-350g" },
