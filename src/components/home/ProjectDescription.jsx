        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="relative h-full bg-white/[0.04] border border-white/10 rounded-2xl p-8 hover:bg-white/[0.06] hover:border-white/20 transition-all duration-500">
                {/* Corner accent */}
                ...
                <motion.div 
                  className="w-12 h-12 rounded-xl bg-white/[0.08] border border-white/20 flex items-center justify-center mb-6 group-hover:bg-white/[0.15] transition-colors duration-300"
