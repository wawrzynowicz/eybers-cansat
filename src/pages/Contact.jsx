...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen pt-24 md:pt-32 pb-16 px-4">
      {/* Background orbs */}
      <GlowingOrb size={450} color="#6366f1" className="-top-40 right-0" opacity={0.2} />
      <GlowingOrb size={350} color="#8b5cf6" className="bottom-20 -left-40" opacity={0.15} />
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Textarea
                        ...
                        onChange={handleChange}
                        required
                        placeholder="Tell us about your inquiry, idea, or how you'd like to collaborate..."
                        rows={5}
                  ...
                  <Button
                    ...
                    className="w-full h-12 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white rounded-xl font-medium shadow-lg shadow-indigo-500/20 transition-all hover:shadow-xl hover:shadow-indigo-500/30"
                  >
                    {mutation.isPending ? (
          ...
          >
            ...
            <div className="bg-gradient-to-br from-indigo-600/20 to-purple-600/20 backdrop-blur-xl border border-indigo-500/20 rounded-3xl p-6 md:p-8">
              ...
              <p className="text-indigo-200/70 text-sm leading-relaxed">
                Whether through sponsorship, mentorship, or resources, your support helps young scientists reach for the stars. Get in touch to learn how you can contribute to our mission.
              </p>
            </div>
          </motion.div>
        </div>
