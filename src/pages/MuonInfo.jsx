      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-6">
          <InfoCard
            ...
            delay={0.1}
            preview={t.muonInfo?.cosmicRays?.p1 || 'The Earth is continuously bombarded by a flux of particles called cosmic rays. These particles travel near the speed of light, carrying enormous amounts of energy.'}
            content={
              <p>
          ...
          <InfoCard
            ...
            delay={0.2}
            preview={t.muonInfo?.birth?.p1 || "Muons aren't originally from cosmic radiation – they are born in Earth's atmosphere."}
            content={
              <p>
          ...
          <InfoCard
            ...
            delay={0.3}
            preview={t.muonInfo?.atmosphere?.p1 || "Primary cosmic rays don't reach Earth's surface directly – our atmosphere acts as a natural shield."}
            content={
              <p>
          ...
          <InfoCard
            ...
            delay={0.4}
            preview={t.muonInfo?.properties?.p1 || 'Mass: 105.65 MeV'}
            content={
              <>
                <p>
          ...
          <InfoCard
            ...
            delay={0.5}
            preview={t.muonInfo?.reach?.p1 || 'Despite their short half-life, muons created at ~15 km altitude reach the surface thanks to special relativity.'}
            content={
              <p>
          ...
          <InfoCard
            ...
            delay={0.6}
            preview={t.muonInfo?.importance?.p1 || 'Muons provide a window into high-energy cosmic processes and allow us to study particle physics at energies impossible to recreate in laboratories.'}
            content={
              <p>
